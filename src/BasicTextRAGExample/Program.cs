...
internal class BasicTextRAGExample
{
    private static async Task Main()
    {
        ...
        TextSearchProviderOptions textSearchProviderOptions = new()
        {
        ...
        AIAgent hrAgent = chatClient.AsAIAgent(new ChatClientAgentOptions()
        {
            ...
            AIContextProviders = [new TextSearchProvider(SearchAdapter, textSearchProviderOptions)]
        });
    ...
    /// </summary>
    private static Task<IEnumerable<TextSearchProvider.TextSearchResult>> SearchAdapter(string query, CancellationToken cancellationToken)
    {
