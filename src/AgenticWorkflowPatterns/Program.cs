...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        var languages = new string[] { "French", "Spanish", "English" };
        ...
        switch (Console.ReadLine())
        {
            case "1":
                ...
                var sequentialWorkflow = AgentWorkflowBuilder.BuildSequential(languages.Select(lang => GetTranslationAgent(lang, client)));
            ...
            case "2":
                ...
                var concurrentWorkflow = AgentWorkflowBuilder.BuildConcurrent(languages.Select(lang => GetTranslationAgent(lang, client)));
